...
int main() {
	...
	int exit_code = local_c + result1 + result2 + fact_result + fib_result + complex + nested +
					...
					pre_inc + post_inc + pre_dec + post_dec + mod_temp + global_counter;

	if (exit_code == 23174 && global_counter == 1 && timer_result == 9 && keyboard_result == 0 && arr_sum == 90 && arr_max == 18 && arr_min == 0 && arr_mod == 90 && arr_cmp == 16 && arr_log == 9 && shift_result == 105 && bitwise_result == 8 && compound_bitwise == 0 && pow2 == 32 && struct_result == 20801 && compound_result == 6 && inc_dec_result == 122 && ternary_result == 60 && ternary_direct == 20 && combined_result == 96 && pre_inc == 21 && post_inc == 20 && pre_dec == 20 && post_dec == 21 && mod_temp == 2)
		print("%s", "Success");
	else
	{
		print("%s", "Fail\n");
		...
		print("%s", "\n");
		print("timer_result=%d", timer_result);
		print("%s", "\n");
		print("keyboard_result=%d", keyboard_result);
		print("%s", "\n");
		print("global_counter=%d", global_counter);
		print("%s", "\n");
		print("arr_sum=%d", arr_sum);
		print("%s", "\n");
		print("arr_max=%d", arr_max);
		print("%s", "\n");
		print("arr_min=%d", arr_min);
		print("%s", "\n");
		print("arr_mod=%d", arr_mod);
		print("%s", "\n");
		print("arr_cmp=%d", arr_cmp);
		print("%s", "\n");
		print("arr_log=%d", arr_log);
		print("%s", "\n");
		print("shift_result=%d", shift_result);
		print("%s", "\n");
		print("bitwise_result=%d", bitwise_result);
		print("%s", "\n");
		print("compound_bitwise=%d", compound_bitwise);
		print("%s", "\n");
		print("pow2=%d", pow2);
		print("%s", "\n");
		print("struct_result=%d", struct_result);
		print("%s", "\n");
		print("compound_result=%d", compound_result);
		print("%s", "\n");
		print("inc_dec_result=%d", inc_dec_result);
		print("%s", "\n");
		print("ternary_result=%d", ternary_result);
		print("%s", "\n");
		print("ternary_direct=%d", ternary_direct);
		print("%s", "\n");
		print("combined_result=%d", combined_result);
		print("%s", "\n");
		print("pre_inc=%d", pre_inc);
		print("%s", "\n");
		print("post_inc=%d", post_inc);
		print("%s", "\n");
		print("pre_dec=%d", pre_dec);
		print("%s", "\n");
		print("post_dec=%d", post_dec);
		print("%s", "\n");
		print("mod_temp=%d", mod_temp);
	}
